...
import bannerBg from '../../assets/proBanBg.png'
        ...
        <>
            <main id='Banner' className='w-full h-[600px] md:h-[730px] pt-2 relative' data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-delay="1000">
                <div className="container px-4 md:px-6">
                    <div id="Banner-Row" className='w-full h-[400px] sm:h-[500px] md:h-[600px] rounded-[20px] bg-cover bg-no-repeat bg-center' style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.6)), url(${bannerBg})`, backgroundAttachment: 'fixed' }}>
                        {/* -------------------- Banner text */}
